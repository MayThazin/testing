...
class CreateDistanceCurriculumsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('distance_curriculums', function (Blueprint $table) {
            ...
            $table->foreign('moduleid')->references('moduleid')->on('distance_syllabus');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('distance_curriculums');
    }
}
